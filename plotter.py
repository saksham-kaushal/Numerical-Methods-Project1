...
def q_a(df,columns,directory):
	...
	# plt.show()
	plt.savefig(directory+'/plots/hist_dist_true-retrieved.jpg',bbox_inches='tight',pad_inches=0.5,dpi=480)
	return
...
def q_b(df,directory):
	...
	# plt.show()
	plt.savefig(directory+'/plots/scatter_retrieved_dist-abs_mag.jpg',bbox_inches='tight',pad_inches=0.5,dpi=480)
	return
...
def q_c(df,directory):
	...
	plt.savefig(directory+'/plots/hist_retrieved_absmag.jpg',bbox_inches='tight',pad_inches=0.5,dpi=480)
	...
	plt.savefig(directory+'/plots/hist_individual_retrieved_absmag.jpg',bbox_inches='tight',pad_inches=0.5,dpi=480)
	# plt.show()
	return
